                ...
                <div class="card register-card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="post" action="">
                            ...
                            <button type="submit" class="btn btn-success btn-action w-100 mt-3">
                                <i class="bi bi-person-plus me-1"></i> Register
                            </button>
                        </form>
                        <div class="mt-4 text-center">
                            <a href="/app/controllers/auth.php?action=login" class="text-decoration-none">Sudah punya akun? <span class="text-success">Login</span></a>
                        </div>
                    </div>
                </div>
