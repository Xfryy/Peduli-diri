                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body text-center py-4">
                                ...
                                <button class="btn btn-primary mt-2" onclick="loadContent('/app/views/catatan_perjalanan.php', this)">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body text-center py-4">
                                ...
                                <button class="btn btn-success mt-2" onclick="loadContent('/app/views/isi_data.php', this)">
